...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" action="{{ route('etablissement.store') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slogan"
                                        ...
                                        placeholder="Veuillez saisir le Slogan d'Établissement" value="{{ old('slogan') }}">
                                    @error('slogan')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="website"
                                        ...
                                        placeholder="Veuillez saisir le Website Établissement" value="https://www.">
                                    @error('website')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
